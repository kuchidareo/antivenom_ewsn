...
Poisoning usage
- Choose one of: none | clean | blurring | occlusion | label-flip | augmentation
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        ...
        type=str,
        default="none",
        choices=["none", "clean", "blurring", "occlusion", "label-flip", "augmentation"],
    )
...
def main() -> None:
    ...
    if args.poison_type == "none":
        ...
        prepared_train = PoisonDiskDataset(
            ...
            tfm_cfg=tfm_cfg,
            expected_poison_frac=None if args.poison_type == "augmentation" else float(args.poison_frac),
        )
